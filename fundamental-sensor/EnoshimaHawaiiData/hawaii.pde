/* @pjs preload="../../img/map.png, ../../img/sunny.png, ../../img/cloudy.png, ../../img/rainy.png, ../../img/enone.png, ../../img/enonex.png, ../../img/wave.png, ../../img/bubble.png, ../../img/weatherbubble.png, ../../img/bubble3.png, ../../img/yashi.png */
...
void drawTextData(){
	...
	text(getHawaiiWeather(), 870, 220);
	text(getEnoshimaTemp() + "℃", 700, 290);
	text(getHawaiiTemp() + "℃", 870, 290);
	text(getEnoshimaHumi() + "％", 700, 360);
	text(getHawaiiHumi() + "％", 870, 360);
	text(getEnoshimaWind() + "m/s", 700, 430);
	text(getHawaiiWind() + "m/s", 870, 430);
}
...
void drawNote(){
	fill(0, 0, 0);
	textSize(20);
	text("「似ている度」は江の島とハワイの本日の天候", 600, 340);
