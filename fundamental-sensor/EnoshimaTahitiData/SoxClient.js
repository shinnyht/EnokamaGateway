...
function getEnoshimaTahiti(){
	return EnoshimaSensorInfo.luigi;
}

function getEnoshimaTahitiWord(){
	return EnoshimaSensorInfo.word;
}

function getEnoshimaTahitiWord2(){
...
function getEnoshimaTemp(){
	return parseFloat(EnoshimaSensorInfo.temperature);		
}

function getEnoshimaHumi(){
	return parseFloat(EnoshimaSensorInfo.humidity);	
}

function getEnoshimaWind(){
	return parseFloat(EnoshimaSensorInfo.wind);
}
...
function getTahitiHumi(){
	return parseFloat(EnoshimaSensorInfo.humidityH);		
}

function getTahitiWind(){
	return parseFloat(EnoshimaSensorInfo.windH);
}
...
$(document).ready(function() {
    ...
    soxEventListener.connected = function(soxEvent) {
        ...
        var deviceNames = ["江ノ島今日の天気", "EnoshimaYachtHarbour", "タヒチ今日の天気"];
