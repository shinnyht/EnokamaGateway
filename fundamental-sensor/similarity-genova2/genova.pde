/* @pjs preload="../../img/map.png, ../../img/sunny.png, ../../img/cloudy.png, ../../img/rainy.png, ../../img/enone.png, ../../img/enonex.png, ../../img/wave.png, ../../img/bubble.png, ../../img/weatherbubble.png, ../../img/bubble3.png, ../../img/genova.png, ../../img/enoshima.png */
...
void drawTextQ(){
	...
	text("Genova\'s Similarity", 600, 220);
	text("is...", 600, 290);
}
...
void drawTextA(){
	...
	String word3 = getEnoshimaGenovaWord3();
	fill(255, 0, 0);
	textSize(70);
	text(luigi + "％", 600, 160);
	fill(0, 0, 0);
...
void drawNote(){
	...
	text("Genova's Weather condition(Weather, Temperature", 600, 430);
